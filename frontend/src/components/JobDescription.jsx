    ...
    useEffect(()=>{
      const fetchSingleJob = async () => {
          try {
              ...
              console.log(res.data.job); // Check the structure 
              console.log(`${res?.data?.job?.title}`);
              
              if(res.data.success){
               
                  dispatch(setSingleJob(res.data.job));

                  setIsApplied(res.data.job.applications.some(application=>application.applicant === user?._id))  //ensure the sate is sync with fetched data
